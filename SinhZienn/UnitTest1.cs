namespace SinhZienn
{
    public class Tests
    {
        ...
        public class SinhVienPolyTests
        {
            ...
            {
                // Arrange
                var sv = new SinhVien("1", "Le Van A", "L01", "Lop 1", "SV001");
            ...
            {
                // Arrange
                var sv = new SinhVien("2", "Le Van B", "L02", "Lop@2", "SV002");
            ...
            {
                // Arrange
                var sv = new SinhVien("3", "Le Van C", "L03", "Lop 3!", "SV003");
            ...
            {
                // Arrange
                var sv = new SinhVien("4", "Le Van D", "L04", "", "SV004");
            ...
            {
                // Arrange
                var sv = new SinhVien("5", "Le Van E", "L05", "Lop 5", "SV005");
            ...
            {
                // Arrange
                var sv1 = new SinhVien("6", "Le Van F", "L06", "Lop 6", "SV006");
                var sv2 = new SinhVien("7", "Le Van G", "L07", "Lop 7", "SV007");
            ...
            {
                // Arrange
                var sv = new SinhVien("11", "Le Van K", "L11", "   ", "SV011");

                // Act & Assert
                Assert.Throws<ArgumentException>(() => _sinhVienPoly.AddSinhVien(sv));
            }
            [Test]
            public void AddSinhVien_MasvWithOnlySpaces_ThrowsArgumentException()
            {
                // Arrange
                var sv = new SinhVien("11", "Le Van K", "L11", "Lz11", "    ");
            ...
            [Test]
            public void AddSinhVien_TenWithOnlySpaces_ThrowsArgumentException()
            {
                // Arrange
                var sv = new SinhVien("11", "    ", "L11", "Lz11", "SV0011");

                // Act & Assert
                Assert.Throws<ArgumentException>(() => _sinhVienPoly.AddSinhVien(sv));
            }
            [Test]
            public void AddSinhVien_AllWithOnlySpaces_ThrowsArgumentException()
            {
                // Arrange
                var sv = new SinhVien("  ", "    ", "   ", "    ", "     ");
            ...
            {
                // Arrange
                var sv = new SinhVien("8", "Le Van H", "L08", "Lop 8", "SV008");
                _sinhVienPoly.AddSinhVien(sv);
                ...
                Assert.AreEqual("Le Van H", result.HoTen);
            }
            ...
            {
                // Arrange
                var sv = new SinhVien("9", "Le Van I", "L09", "Lop 9", "SV009");
                _sinhVienPoly.AddSinhVien(sv);
            ...
            {
                // Arrange
                var sv = new SinhVien("10", "Le Van J", "L10", "Lop 10", "SV010");
                _sinhVienPoly.AddSinhVien(sv);
                ...
                // Assert
                Assert.IsNotNull(result);
                Assert.AreEqual("Le Van J", result.HoTen);
            }
